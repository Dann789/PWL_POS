            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @if($user->avatar)
                                <img src="{{ asset('storage/photos/'.$user->avatar) }}" class="img-thumbnail rounded mx-auto d-block" alt="Profile Picture">
                            @else
                                <div class="img-thumbnail rounded mx-auto d-block" style="width: 150px; height: 150px; background-color: #f0f0f0;">
                                    <!-- Optional Placeholder Text or Icon -->
                                    <span class="text-muted d-flex justify-content-center align-items-center" style="height: 100%;">No Image</span>
                                </div>
                            @endif
                        </div>
                        <div class="col-md-8">
