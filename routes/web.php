...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('/create_ajax', [UserController::class, 'create_ajax']); // Menampilkan halaman form tambah ajax
...
Route::group(['prefix' => 'level'], function () {
    ...
    Route::get('/create_ajax', [LevelController::class, 'create_ajax']); // Menampilkan halaman form tambah ajax
...
Route::group(['prefix' => 'kategori'], function () {
    ...
    Route::get('/create_ajax', [KategoriController::class, 'create_ajax']); // Menampilkan halaman form tambah ajax
    Route::post('/ajax', [KategoriController::class, 'store_ajax']); // Menyimpan data kategori baru dengan ajax
...
Route::group(['prefix' => 'barang'], function () {
    ...
    Route::get('/create_ajax', [BarangController::class, 'create_ajax']); // Menampilkan halaman form tambah ajax
    Route::post('/ajax', [BarangController::class, 'store_ajax']); // Menyimpan data barang baru dengan ajax
...
Route::group(['prefix' => 'supplier'], function () {
    ...
    Route::get('/create_ajax', [SupplierController::class, 'create_ajax']); // Menampilkan halaman form tambah ajax
